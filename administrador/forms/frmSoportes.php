...
<script type="text/javascript">
    ...
    function nuevoProg() {
        ...
        $('#resultado').load('administrador/forms/frmSoporteProgramado.php', {evento: 'agregar', id: ''}, function() {
    ...
    $('#tab3').click(function() {
        $('#cont3').load('administrador/vistas/vistaEquiposEnSucursales.php', {id: id});
    })
    $('#tab4').click(function() {
        var id = $("#cmbProblema").val();
        $('#cont4').load('administrador/vistas/vistaRecomendacionesPorProblema.php', {id: id});
    })
    ...
    function enviar() {
        ...
        //alert(idSop+' '+id)
        $('#cargando').css("display", "block");
        $('#resultado').load('administrador/scripts/scSoportes.php', datos, function() {
            $("#cargando").css("display", "none");
            $('.ui-dialog-titlebar-close').click();
        });
    }
