...
<script type="text/javascript">
    ...
    function irDetalle(id) {
        ...
        $('#resultado').load('administrador/dialogs/dialogDetalleDiagnosticoReparacion.php', {id: id}, function() {
    ...
    function filtrar() {
        ...
        $('#cargando').css("display", "block");
        $('#section').load('administrador/vistas/vistaDiagnosticoReparacionEquipos.php', {filtro: id}, function() {
            $("#cargando").css("display", "none");
        });
    }
    ...
    function nuevo() {
        ...
        $('#cargando').css("display", "block");
        $('#resultado').load('administrador/forms/frmDiagnosticoEquipos.php', {evento: 'agregar'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function nuevoReparacion() {
        $('.chk').each(function() {
            if ($(this).is(':checked')) {
                ...
                //llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/forms/frmReparacionEquipos.php', {evento: 'agregar', id: id}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
    ...
    function editar() {
        $('.chk').each(function() {
            if ($(this).is(':checked')) {
                ...
                //llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/forms/frmDiagnosticoEquipos.php', {evento: 'modificar', id: id}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
    ...
    function eliminar() {
        smoke.confirm('¿Esta seguro que desea eliminar el (los) elemento(s)?', function(event) {
            if (event) {
                ...
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/scripts/scDiagnosticoEquipos.php', {evento: 'eliminar', matrizEliminar: matrizEliminar}, function() {
                    $("#cargando").css("display", "none");
                });
