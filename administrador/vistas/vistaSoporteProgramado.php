...
<script type="text/javascript">
    ...
    function filtrar() {
        ...
        $('#section').load('administrador/vistas/vistaSoporteProgramado.php', {filtroPaises: idPais, filtroClientes: idCliente}, function() {
    ...
    function editarProg() {
        $('.chkSop').each(function() {
            if ($(this).is(':checked')) {
                ...
                //llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/forms/frmSoporteProgramado.php', {evento: 'modificar', id: idSuc, idSop: idSop}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
    ...
    function eliminarProg() {
        smoke.confirm('¿Esta seguro que desea eliminar el (los) elemento(s)?', function(event) {
            if (event) {
                ...
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/scripts/scSoportesProgramados.php', {evento: 'eliminar', matrizEliminar: matrizEliminar}, function() {
                    $("#cargando").css("display", "none");
                });
...
<div class="container-top"> 
    ...
    <button type="button" id="btnEliminar" class="btn btn-default paginate_button_disabled" onclick="eliminarProg()" disabled>
