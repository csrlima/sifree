...
<script type="text/javascript">
    ...
    function filtrar() {
        ...
        $('#section').load('administrador/vistas/vistaListaSoportes.php', {filtroTipo: tipo, filtroClientes: idCliente, fecha: fecha}, function() {
...
<div class="container-top" style="min-width: 200px"> 
    ...
    <!--    <a class="btn btn-default" 
           href="administrador/graficos/grxlsListaSucursales.php?filtroTipo=<?php echo $filtroTipo; ?>&filtroClientes=<?php echo $filtroClientes; ?>&fecha=<?php echo $fecha; ?>">
            <span class="glyphicon glyphicon-print"></span> Imprimir como Hoja de Cálculo</a>-->
</div>
<hr>
<div>
    <div class="print-section">
