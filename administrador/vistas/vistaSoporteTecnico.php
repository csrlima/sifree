...
<script type="text/javascript">
    ...
    function irSoporteProgramado() {
        ...
        $('#section').load('administrador/vistas/vistaSoporteProgramado.php', {filtroPaises: '0', filtroClientes: '0', opcion: ''}, function() {
    ...
    function filtrar() {
        ...
        $('#cargando').css("display", "block");
        $('#section').load('administrador/vistas/vistaSoporteTecnico.php', {filtroPaises: idPais, filtroClientes: idCliente}, function() {
            $("#cargando").css("display", "none");
        });
    }
    ...
    function detalles(id) {
        ...
        $('#cargando').css("display", "block");
        $('#resultado').load('administrador/dialogs/dialogDetalleSoporteTecnico.php', {id: id}, function() {
            $("#cargando").css("display", "none");
        });
    }
