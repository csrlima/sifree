...
//llamado al form por ajax
        $('#cargando').css("display", "block");
        $('#resultado').load('administrador/forms/frmEquipos.php', {evento: 'agregar'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function historial() {
...
//llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/vistas/vistaHistorialEquiposSucursal.php', {id: id}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
...
//llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/forms/frmEquipos.php', {evento: 'modificar', id: id}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
...
//llamado al script por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('administrador/scripts/scEquipos.php', {evento: 'eliminar', matrizEliminar: matrizEliminar}, function() {
                    $("#cargando").css("display", "none");
                });
                ...
                <table class="table table-condensed table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Marca</th>
                            <th>Modelo</th>
                            <th style="width: 160px">Equipos Instalados</th>
                            <th style="width: 170px">Equipos En Stock</th>
