...
<script>
    ...
    function irSucursalesClientes(){
        ...
        $('#section').load('administrador/graficos/grSucurcalesCliente.php', {}, function() {
    ...
    function irListaSoportes(){
        $('#cargando').css("display", "block");
        $('#section').load('administrador/vistas/vistaListaSoportes.php', {filtroTipo: '0',filtroClientes: '0'}, function() {
            $("#cargando").css("display", "none");
        });
    }    
    ...
    function irSoportesMesActual(){
        $('#cargando').css("display", "block");
        $('#section').load('administrador/graficos/grSoportesMesActual.php', {}, function() {
            $("#cargando").css("display", "none");
        });
    }    
    ...
    function irSoportesAtendidosSucursales(){
        $('#cargando').css("display", "block");
        $('#section').load('administrador/graficos/grSoportesAtendidosSucursales.php', {filtroClientes: '0', fecha: ''}, function() {
            $("#cargando").css("display", "none");
        });
    }  
    ...
    function irSoportesAtendidosUsuarios(){
        $('#cargando').css("display", "block");
        $('#section').load('administrador/graficos/grSoportesAtendidosUsuarios.php', {fecha: ''}, function() {
            $("#cargando").css("display", "none");
        });
    }    
    ...
    function irTiempoRespuestaSoportes(){
        $('#cargando').css("display", "block");
      $('#section').load('administrador/vistas/vistaListaTiempoRespuesta.php', {filtroTipo: '0',filtroClientes: '0'}, function() {
            $("#cargando").css("display", "none");
        });
    }    
    ...
    function irActividadEquiposCategoria(){
        $('#cargando').css("display", "block");
        $('#section').load('administrador/graficos/grActividadEquiposCategoria.php', {}, function() {
            $("#cargando").css("display", "none");
        });
    }    
    ...
    function irEstadoEquiposCategoria(){
        $('#cargando').css("display", "block");
        $('#section').load('administrador/graficos/grEstadoEquiposCategoria.php', {}, function() {
            $("#cargando").css("display", "none");
        });
    }
