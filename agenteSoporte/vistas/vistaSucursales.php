...
<script type="text/javascript">
    //funcion para ir a detalle
     function irDetalle(id) {
        ...
        $('#resultado').load('agenteSoporte/dialogs/dialogDetalleSucursales.php', {id: id}, function() {
    ...
    function filtrar() {
        ...
        $('#cargando').css("display", "block");
        $('#section').load('agenteSoporte/vistas/vistaSucursales.php', {filtro: id}, function() {
            $("#cargando").css("display", "none");
        });
    }
    ...
    function nuevo() {
        //llamado al form por ajax
        $('#cargando').css("display", "block");
        $('#resultado').load('agenteSoporte/forms/frmSucursales.php', {evento: 'agregar'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    //llamado al form agregar nuevo registro
    ...
    function historialSoporte() {
        $('.chk').each(function() {
            if ($(this).is(':checked')) {
                ...
                //llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('agenteSoporte/dialogs/dialogHistorialSoporteSucursal.php', {evento: 'agregar', id: id}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
    ...
    function editar() {
        $('.chk').each(function() {
            if ($(this).is(':checked')) {
                ...
                //llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('agenteSoporte/forms/frmSucursales.php', {evento: 'modificar', id: id}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
