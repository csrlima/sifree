...
<script type="text/javascript">
    ...
    function nuevoProg() {
        ...
        $('#resultado').load('agenteSoporte/forms/frmSoporteProgramado.php', {evento: 'agregar', id: ''}, function() {
    ...
    $('#tab4').click(function() {
        ...
        $('#cont4').load('agenteSoporte/vistas/vistaRecomendacionesPorProblema.php', {id: id});
    })
    ...
    function enviar() {
        ...
        //alert(idSop+' '+id)
        $('#cargando').css("display", "block");
        $('#resultado').load('agenteSoporte/scripts/scSoportes.php', datos, function() {
            $("#cargando").css("display", "none");
            $('.ui-dialog-titlebar-close').click();
        });
    }
