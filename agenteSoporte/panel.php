...
<script type="text/javascript">
    function irSoportesObservacion() {
        ...
        $('#section').load('agenteSoporte/vistas/vistaSoporteTecnico.php', {filtroPaises: '0', filtroClientes: '0', opcion: 'observacion'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irSoportesLLamadasCaducadas() {
        $('#cargando').css("display", "block");
        $('#section').load('agenteSoporte/vistas/vistaSoporteProgramado.php', {filtroPaises: '0', filtroClientes: '0', opcion: 'llamadasCaducadas'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irSoportesVisitasCaducadas() {
        $('#cargando').css("display", "block");
        $('#section').load('agenteSoporte/vistas/vistaSoporteProgramado.php', {filtroPaises: '0', filtroClientes: '0', opcion: 'visitasCaducadas'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irSoportesLLamadasPendientes() {
        $('#cargando').css("display", "block");
        $('#section').load('agenteSoporte/vistas/vistaSoporteTecnico.php', {filtroPaises: '0', filtroClientes: '0', opcion: 'llamadasPendientes'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irSoportesVisitasPendientes() {
        $('#cargando').css("display", "block");
        $('#section').load('agenteSoporte/vistas/vistaSoporteTecnico.php', {ffiltroPaises: '0', filtroClientes: '0', opcion: 'visitasPendientes'}, function() {
            $("#cargando").css("display", "none");
        });
    }
