...
if ($evento == 'modificar') {
    $base = new mySQLData();
    $result = $base->consulta("SELECT modelos.id_categoria_equipo,componentes_agentes.id_modelo,estado_com_agente,costo_com_agente
...
<script type="text/javascript">
    ...
    function enviar(){ 
        ...
        $('#resultado').load('superadministrador/scripts/scComponentesAgentes.php', datos, function() {
...
<div id="dialog-modal">
    <h2>Formulario de Componentes de Agentes</h2>
    <!--boton regresar-->
