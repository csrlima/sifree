...
if ($evento == 'modificar') {
    $base = new mySQLData();
    $result = $base->consulta("SELECT nombre_tipo_danio FROM tipos_danios WHERE id_tipo_danio='$id'");
...
<script type="text/javascript">
    ...
    function enviar(){ 
        ...
        $('#resultado').load('superadministrador/scripts/scTiposDaniosEquipos.php', datos, function() {
...
<div id="dialog-modal">
    <h2>Formulario de Tipo de Daños en Equipos</h2>
    <!--boton regresar-->
    ...
    <form class="form-horizontal" role="form" action="javascript:enviar();" method="POST">
        ...
        <div class="form-group">
            <label for="txtNombre" class="col-sm-2 control-label">Nombre Tipo Daño</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="txtNombre" name="txtNombre" placeholder="Nombre de tipo de Daño">
            </div>
        </div> 
        <!--boton de guardar-->
        <div class="form-group">
