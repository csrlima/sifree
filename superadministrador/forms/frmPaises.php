...
<script type="text/javascript">
    ...
    function enviar() {
        ...
        $('#resultado').load('superadministrador/scripts/scPaises.php', datos, function() {
...
<div id="dialog-modal">
    ...
    <form class="form-horizontal" role="form" action="javascript:enviar();" method="POST">
        ...
        <div class="form-group">
            <label for="txtNombre" class="col-sm-2 control-label">Nombre País</label>
            <div class="col-sm-3">
