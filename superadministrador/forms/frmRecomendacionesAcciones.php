...
if ($evento == 'modificar') {
    $base = new mySQLData();
    $result = $base->consulta("SELECT * FROM recomendaciones_acciones_soportes WHERE id_rec_accion_soporte='$id'");
...
<script type="text/javascript">
    ...
    function enviar(){ 
        ...
        $('#resultado').load('superadministrador/scripts/scRecomendacionesAccionesSoporte.php', datos, function() {
...
<div id="dialog-modal">
    <h2>Formulario de Recomendaciones Acciones de Soporte</h2>
    <!--boton regresar-->
    ...
    <form class="form-horizontal" role="form" action="javascript:enviar();" method="POST">
        ...
        <div class="form-group">
            <label for="txtNombre" class="col-sm-2 control-label">Nombre Acción de Soporte</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="txtNombre" name="txtNombre" placeholder="Nombre Acción de Soporte">
            </div>
        </div>
