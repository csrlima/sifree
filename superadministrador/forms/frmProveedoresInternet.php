...
if ($evento == 'modificar') {
    $base = new mySQLData();
    $result = $base->consulta("SELECT nombre_proveedor_internet,telefono_proveedor_internet,id_pais
                FROM proveedores_internet
...
<script type="text/javascript">
    ...
    function enviar(){ 
        ...
        $('#resultado').load('superadministrador/scripts/scProveedoresInternet.php', datos, function() {
...
<div id="dialog-modal">
    <h2>Formulario de Proveedores de Internet</h2>
    <!--boton regresar-->
    ...
    <form class="form-horizontal" role="form" action="javascript:enviar();" method="POST">
        ...
        <div class="form-group">
            <label for="txtNombre" class="col-sm-2 control-label">Nombre Proveedor</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="txtNombre" name="txtNombre" placeholder="Nombre Proveedor">
            </div>
        </div>
        
        <div class="form-group">
            <label for="cmbPais" class="col-sm-2 control-label">País Proveedor</label>
            <div class="col-sm-3"> 
...
<!--        <div class="form-group">
            <label for="txtTest" class="col-sm-2 control-label">txtTest</label>
            <div class="col-sm-3"> 
                <textarea class="form-control" id="txtText" name="txtTest"></textarea>
            </div>
        </div> -->
        <!--boton de guardar-->
        <div class="form-group">
