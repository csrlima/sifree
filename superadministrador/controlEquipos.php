<script>
    ...
    function irComponentesAgentes() {
        $('#cargando').css("display", "block");
        $('#section').load('superadministrador/vistas/vistaComponentesAgentes.php', {filtro:'0'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irMarcas() {
        $('#cargando').css("display", "block");
        $('#section').load('superadministrador/vistas/vistaMarcas.php', {}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irModelos() {
        $('#cargando').css("display", "block");
        $('#section').load('superadministrador/vistas/vistaModelos.php', {filtro:'0'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irCategoriasEquipos() {
        $('#cargando').css("display", "block");
        $('#section').load('superadministrador/vistas/vistaCategoriasEquipos.php', {}, function() {
            $("#cargando").css("display", "none");
        });
    }
    ...
    function irDiagnosticoReparacionEquipos() {
        $('#cargando').css("display", "block");
        $('#section').load('superadministrador/vistas/vistaDiagnosticoReparacionEquipos.php', {}, function() {
            $("#cargando").css("display", "none");
        });
    }
    function irIndividualComponentesAgente() {
        $('#cargando').css("display", "block");
        $('#section').load('superadministrador/vistas/vistaIndividualComponentesAgente.php', {filtro:'0'}, function() {
            $("#cargando").css("display", "none");
        });
    }    
</script>
