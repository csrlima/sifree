...
<script type="text/javascript">
    ...
    function irSoporteProgramado() {
        ...
        $('#section').load('superadministrador/vistas/vistaSoporteProgramado.php', {filtroPaises: '0', filtroClientes: '0', opcion: ''}, function() {
    ...
    function filtrar() {
        ...
        $('#cargando').css("display", "block");
        $('#section').load('superadministrador/vistas/vistaSoporteTecnico.php', {filtroPaises: idPais, filtroClientes: idCliente}, function() {
            $("#cargando").css("display", "none");
        });
    }
    ...
    function detalles(id) {
        ...
        $('#cargando').css("display", "block");
        $('#resultado').load('superadministrador/dialogs/dialogDetalleSoporteTecnico.php', {id: id}, function() {
            $("#cargando").css("display", "none");
        });
    }
...
<!--***********NUEVA PARTE**********-->
<div style="float: right; margin-top: 30px" class="container-top" id="container-top-right">  
...
<div class="container-top"> 
    ...
    <button type="button" id="btnEliminar" class="btn btn-default paginate_button_disabled" onclick="eliminarSop()" disabled>
