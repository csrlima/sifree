...
<script type="text/javascript">
    ...
    function filtrar(){
        ...
        $('#section').load('superadministrador/vistas/vistaIndividualComponentesAgente.php', {filtro:id}, function() {
    ...
    function nuevo() {
        ...
        $('#cargando').css("display", "block");
        $('#resultado').load('superadministrador/forms/frmConstruccionAgente.php', {evento: 'agregar',id:filtro}, function() {
            $("#cargando").css("display", "none");
        });
    }
    ...
    function eliminar() {
        smoke.confirm('¿Esta seguro que desea desvincular el (los) elemento(s) del agente? \n Esto no lo eliminará de la base datos.', function(event) {
            if (event) {
                ...
                $('#cargando').css("display", "block");
                $('#resultado').load('superadministrador/scripts/scConstruccionAgente.php', {evento: 'eliminar', matrizEliminar: matrizEliminar,id:filtro}, function() {
                    $("#cargando").css("display", "none");
                });
