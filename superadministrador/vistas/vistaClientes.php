...
<script type="text/javascript">
    ...
    function filtrar(){
        ...
        $('#section').load('superadministrador/vistas/vistaClientes.php', {filtro:id}, function() {
    ...
    function nuevo() {
        ...
        $('#cargando').css("display", "block");
        $('#resultado').load('superadministrador/forms/frmClientes.php', {evento: 'agregar'}, function() {
            $("#cargando").css("display", "none");
        });
    }
    ...
    function editar() {
        $('.chk').each(function() {
            if ($(this).is(':checked')) {
                ...
                //llamado al form por ajax
                $('#cargando').css("display", "block");
                $('#resultado').load('superadministrador/forms/frmClientes.php', {evento: 'modificar', id: id}, function() {
                    $("#cargando").css("display", "none");
                });
                return;
            }
    ...
    function eliminar() {
        smoke.confirm('¿Esta seguro que desea eliminar el (los) elemento(s)?', function(event) {
            if (event) {
                ...
                $('#cargando').css("display", "block");
                $('#resultado').load('superadministrador/scripts/scClientes.php', {evento: 'eliminar', matrizEliminar: matrizEliminar}, function() {
                    $("#cargando").css("display", "none");
                });
